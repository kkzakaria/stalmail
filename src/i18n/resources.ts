export const fr = {
  ...
  mail: {
    ...
    compose: {
      ...
      forward: "Transférer",
      forwardMessage: "Transférer le message de {{sender}}",
      bold: "Gras",
      italic: "Italique",
    ...
    reader: {
      ...
      toggleMessage: "Message de {{sender}}",
      back: "Retour",
      archive: "Archiver",
      trash: "Supprimer",
      snooze: "Reporter",
...
export const en: DeepRecord<typeof fr> = {
  ...
  mail: {
    ...
    compose: {
      ...
      replyAll: "Reply all",
      forward: "Forward",
      forwardMessage: "Forward the message from {{sender}}",
      bold: "Bold",
      italic: "Italic",
      link: "Insert link",
    ...
    reader: {
      ...
      messages_one: "{{count}} message",
      messages_other: "{{count}} messages",
      toggleMessage: "Message from {{sender}}",
      back: "Back",
      archive: "Archive",
      trash: "Delete",
      snooze: "Snooze",
