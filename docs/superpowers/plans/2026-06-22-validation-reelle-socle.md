...
Acceptation A1–A4 ✅, E2/F1–F3 ✅, E1 ⚠️ (livré mais spam = réputation neuve, hors socle).
**Restent** : A5, B→D (auth/liste/lecteur), E3–E9 (réception/sandbox/composer). Warm-up Gmail
en parallèle (marquer non-spam, Google Postmaster Tools) pour sortir du spam.
