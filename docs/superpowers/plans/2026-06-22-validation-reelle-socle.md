...
| C1 Dossiers | ✅ Pass | tous présents (Inbox/Favoris/En attente/Sent/Drafts/Archive/Spam/Trash). *« Archivés » fantôme — cf. #73.* |
...
| D4 Actions (★/lu/archive/trash/spam) | ⚠️ Partiel | Favori ★ / lu-non-lu / **Corbeille** / **Spam** ✅ ; **Archiver ❌** (#73 — Stalwart ne provisionne pas le dossier rôle `archive`). |
...
téléchargement non câblé) ; **D4 ⚠️** (Archiver cassé #73) ; **E6 ⚠️** (transfert pas un vrai transfert
...
manuellement, + **#73 (Archiver)** et **#79 (transfert)** à concevoir. Warm-up Gmail en parallèle.
...
| **Action « Archiver » cassée** : Stalwart ne provisionne pas de mailbox de rôle `archive` | issue **#73** |
