...
Réception externe→interne OK (en inbox), lecteur **iframe sandbox + blocage d'images** validé.
Acceptation A1–A4 ✅, D1/D2 ✅, E2/E3 ✅, F1–F3 ✅, E1 ⚠️ (livré mais spam = réputation neuve,
hors socle). **Restent** : A5, B (session), C (liste), D3/D4 (pièce jointe, actions), E4–E9
(répondre/transférer/sanitisation/validation/rate-limit). Warm-up Gmail en parallèle (marquer
non-spam, Google Postmaster Tools) pour sortir du spam.
